...
public class CommandKick implements ICommand
{
	...
	public void execute(ICommandSender icommandsender, String[] astring)
	{
		...
		if (kicked.getDisplayNameString().toLowerCase().equals(((EntityPlayer) icommandsender.getCommandSenderEntity())
		...
		for (Entity member : party.getMembers())
		{
			if (member instanceof EntityPlayer)
			{
				...
				player.addChatMessage(new ChatComponentText(kicked.getDisplayNameString() + 
