...
public class SpellHaste extends SpellAura
{
	public static final String NAME = "haste";
	public static final int enchID = 106;
	public static final int DURATION = 20 * 30;
	public static final String[] DESCRIPTION = new String[] { "enchantment.haste.desc.1" };
	...
	public int getColor()
	{
		return Potion.digSpeed.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.digSpeed.id, DURATION, level - 1));
			return true;
		}
