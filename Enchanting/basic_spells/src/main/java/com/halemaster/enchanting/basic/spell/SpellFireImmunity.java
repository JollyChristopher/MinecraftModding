...
public class SpellFireImmunity extends SpellAura
{
	public static final String NAME = "fireimmunity";
	public static final int enchID = 104;
	public static final int DURATION = 20 * 60;
	public static final String[] DESCRIPTION = new String[] { "enchantment.fireimmunity.desc.1" };
	private static Random random = new Random();

	public SpellFireImmunity()
	{
	...
	public int getColor()
	{
		return Potion.fireResistance.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.fireResistance.id, DURATION * level, 0));
			return true;
		}
