...
public class SpellHopping extends SpellAura
{
	public static final String NAME = "hopping";
	public static final int enchID = 109;
	public static final int DURATION = 20 * 30;
	public static final String[] DESCRIPTION = new String[] { "enchantment.hopping.desc.1" };
	...
	public int getColor()
	{
		return Potion.jump.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.jump.id, DURATION, level - 1));
			return true;
		}
