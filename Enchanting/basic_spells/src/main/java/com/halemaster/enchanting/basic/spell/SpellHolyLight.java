...
public class SpellHolyLight extends SpellProjectile
{
	public static final String NAME = "holylight";
	public static final int enchID = 108;
	public static final String[] DESCRIPTION = new String[] { "enchantment.holylight.desc.1"};
	private static Random random = new Random();
	private static Item holyLight_spell = null;

	public SpellHolyLight()
	{
		super(enchID, new ResourceLocation(BasicSpellbookMod.MODID, NAME), EnumRarity.RARE);
		this.setName(NAME);
		if(holyLight_spell == null)
		{
			holyLight_spell = new Item().setUnlocalizedName(NAME).setMaxStackSize(1);
			GameRegistry.registerItem(holyLight_spell, NAME);
		}
		
		setItem(holyLight_spell);
	}
