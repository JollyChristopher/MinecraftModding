...
public class SpellVigor extends SpellAura
{
	public static final String NAME = "vigor";
	public static final int enchID = 121;
	public static final int DURATION = 20 * 30;
	public static final String[] DESCRIPTION = new String[] { "enchantment.vigor.desc.1" };
	...
	public int getColor()
	{
		return Potion.healthBoost.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.healthBoost.id, DURATION, level - 1));
			return true;
		}
