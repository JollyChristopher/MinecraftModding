...
public class SpellSwiftness extends SpellAura
{
	public static final String NAME = "swiftness";
	public static final int enchID = 120;
	public static final int DURATION = 20 * 30;
	public static final String[] DESCRIPTION = new String[] { "enchantment.swiftness.desc.1" };
	...
	public int getColor()
	{
		return Potion.moveSpeed.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, DURATION, level - 1));
			return true;
		}
