...
public class SpellVigorTest {
	private static SpellVigor spell;

	@BeforeClass
	public static void init() {
		spell = (SpellVigor) EnchantingMod.getSpell(SpellVigor.enchID);
	}

	@Test
	public void testGetColor() {
		assertEquals("Color: healthBoost", Potion.healthBoost.getLiquidColor(), spell.getColor());
	}
	...
	public void testGetRawDescription() {
		...
		assertEquals("Description[0]", "enchantment.vigor.desc.1",
	...
	public void testGetRenderName(){
		assertEquals("Render name", "vigor", spell.getRenderName());
	}
