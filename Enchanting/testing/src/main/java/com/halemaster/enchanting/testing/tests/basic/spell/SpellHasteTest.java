...
public class SpellHasteTest {
	private static SpellHaste spell;

	@BeforeClass
	public static void init() {
		spell = (SpellHaste) EnchantingMod.getSpell(SpellHaste.enchID);
	}

	@Test
	public void testGetColor() {
		assertEquals("Color: digSpeed", Potion.digSpeed.getLiquidColor(), spell.getColor());
	}
	...
	public void testGetRawDescription() {
		...
		assertEquals("Description[0]", "enchantment.haste.desc.1",
	...
	public void testGetRadius() {
		...
		assertEquals("Max Level", 10.0, spell.getRadius(spell.getMaxLevel()), 0.1);
	}
	...
	public void testGetRenderName(){
		assertEquals("Render name", "haste", spell.getRenderName());
	}
