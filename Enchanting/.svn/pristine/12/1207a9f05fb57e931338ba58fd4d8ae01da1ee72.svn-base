...
public class SpellPower extends SpellAura
{
	public static final String NAME = "power";
	public static final int enchID = 116;
	public static final int DURATION = 20 * 30;
	public static final String[] DESCRIPTION = new String[] { "enchantment.power.desc.1" };
	...
	public int getColor()
	{
		return Potion.damageBoost.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.damageBoost.id, DURATION, level - 1));
			return true;
		}
