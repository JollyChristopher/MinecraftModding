...
public class SpellWaterBreathing extends SpellAura
{
	public static final String NAME = "waterbreathing";
	public static final int enchID = 122;
	public static final int DURATION = 20 * 180;
	public static final String[] DESCRIPTION = new String[] { "enchantment.waterbreathing.desc.1" };
	...
	public int getColor()
	{
		return Potion.waterBreathing.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, DURATION * level, 0));
			return true;
		}
