...
public class SpellInvulnerability extends SpellAura
{
	public static final String NAME = "invulnerability";
	public static final int enchID = 112;
	public static final int DURATION = 20 * 15;
	public static final String[] DESCRIPTION = new String[] { "enchantment.invulnerability.desc.1" };
	private static Random random = new Random();

	public SpellInvulnerability()
	{
	...
	public int getColor()
	{
		return Potion.resistance.getLiquidColor();
	}
	...
	public boolean auraHit(ItemStack stack, World worldIn, EntityPlayer playerIn, int level, EntityLivingBase entity)
	{
		...
		{
			entity.addPotionEffect(new PotionEffect(Potion.resistance.id, DURATION, level - 1));
			return true;
		}
