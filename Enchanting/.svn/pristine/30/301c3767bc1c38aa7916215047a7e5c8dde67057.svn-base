...
public class SpellHolyLightTest {
	private static SpellHolyLight spell;

	@BeforeClass
	public static void init() {
		spell = (SpellHolyLight) EnchantingMod.getSpell(SpellHolyLight.enchID);
	}
	...
	public void testGetRawDescription() {
		...
		assertEquals("Description[0]", "enchantment.holylight.desc.1",
